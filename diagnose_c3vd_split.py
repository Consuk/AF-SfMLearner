...
def main():
    parser = argparse.ArgumentParser("Diagnose C3VD split quality for AF-SfMLearner training")
    ...
    for i, line in enumerate(lines):
        ...
        try:
            ...
            if opt.inspect_modes and checked_modes < opt.max_mode_checks:
                ...
                checked_modes += 1
                # Typical RGB images should be mode "RGB" or at least 3-channel-ish.
