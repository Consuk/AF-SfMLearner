...
csv_path = "hamlyn_corruptions_summary_AF2.csv"
...
if "corruption" in df.columns:
    ...
    avg_per_corr.to_csv("corruption_averages_hamlyn_AF2.csv", index=False)
    print("\nPromedios por corrupción guardados en 'corruption_averages_AF2.csv'")
